...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getEmployeeById(@PathVariable Long empId) {
        Employee employee = iEmployeeService.getEmployeeById(empId);
        if (employee != null) {
    ...
    public ResponseEntity<Employee> updateEmployee(@PathVariable Long empId, @RequestBody Employee employee) {
        try {
            Employee updatedEmployee = iEmployeeService.updateEmployee(empId, employee);
    ...
    public ResponseEntity<String> deleteEmployee(@PathVariable Long empId) {
        try {
            iEmployeeService.deleteEmployee(empId);
            return ResponseEntity.ok("Employee with ID " + empId + " deleted successfully");
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body("Failed to delete employee with ID " + empId);
        }
